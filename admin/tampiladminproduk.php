...
<body>
    ...
    $data_admin = $database->tampil_produk();
    ?>
    ...
    <table class="table table-hover" style=' text-align:center;' border="1">
        ...
        <th style='width:120px;text-align: center;'>Generasi</th>
        <th style='width:140px;text-align: center;'>Litografi</th>
		...
		foreach($data_admin as $row){
			...
			<tr>
				...
				<td style='text-align: center;'><?php echo $row['gen']; ?></td>
				<td style='text-align: center;'><?php echo $row['litografi']; ?></td>
                <td style='text-align: center;'><?php echo $row['corenum']; ?></td>
                <td style='text-align: center;'><?php echo $row['threadnum']; ?></td>
                <td style='text-align: center;'><?php echo $row['basefrek']; ?></td>
                <td style='text-align: center;'><?php echo $row['maxfrek']; ?></td>
                <td style='text-align: center;'><?php echo $row['cache']; ?></td>
                <td style='text-align: center;'><?php echo $row['tdp']; ?></td>
                <td style='text-align: center;'><?php echo $row['maxmem']; ?></td>
                <td style='text-align: center;'><?php echo $row['memtype']; ?></td>
                <td style='text-align: center;'><?php echo $row['graph']; ?></td>
                <td style='text-align: center;'><?php echo $row['soket']; ?></td>
                <td style='text-align: center;'><?php echo $row['harga']; ?></td>
                <td style='text-align: center;'><?php echo $row['foto']; ?></td>
				<td style='text-align: center;'>
					<a style='color:blue;' href="editadminproduk.php?id=<?php echo $row['id']; ?>">Update</a> ||
					<a style='color:red;' onClick="return confirm('Yakin dihapus?')" href="../Config/updateproduk.php?action=delete&id=<?php echo $row['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php 
            $no++;
