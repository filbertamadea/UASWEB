...
if(isset($_POST['register']))
{
    ...
    $ig = $_POST['ig'];
    $foto = $_POST['foto'];
    if($database->register($id,$username,$password,$nama,$email,$Jabatan,$jk,$tgllahir,$notelp,$ig,$foto))
    {
      header('location:../Pesan/Pesanregisteradmin.php');
    }
}
?>
<!DOCTYPE html>
    ...
    <p class="lead">Silahkan Daftarkan Identitas Anda</p>
        ...
        <form method="post" action="">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-3">
					<input id="jk" type="radio" name="jk" value="Laki-Laki">
					<label >Laki-Laki</label>
				</div>
				<div class="col-sm-3">
					<input id="jk" type="radio" name="jk" value="Perempuan">
            ...
            <div class="form-group row">
                <label for="tgllahir" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tgllahir" name="tgllahir" placeholder="1 Maret 2000">
                    </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="ig" class="col-sm-2 col-form-label">ID Instagram</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ig" name="ig" placeholder="Instagram ID">
                    </div>
            </div>
            <div class="form-group row">
                <label for="foto" class="col-sm-2 col-form-label">Foto</label>
                    <div class="col-sm-10">
                        <input type="file" accept="image/png, image/gif, image/jpeg" class="form-control" id="foto" name="foto">
                    </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="register">Register</button>
                    <a href="adminpage.php" class="btn btn-success">Kembali</a>
                </div>
            </div>
        </form>
    </div>
