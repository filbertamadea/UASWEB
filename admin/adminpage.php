    ...
    <div class="wrapper">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Halaman Admin</p>
                <li class="active">
                    <a href="#admin" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Admin</a>
                ...
                <li class="active">
                    <a href="#produk" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Produk</a>
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" style='margin-left:5%; font-size:50px;'>Profile</h1>
                <?php
            ...
            <div class="row" style='margin-left:5%;'>
                <div clas="col-lg-5">
                    <img class='img-fluid rounded-circle' src='../img/<?php echo $_SESSION['foto']; ?>'
                                width='200' height='150' alt="sorry we cant display this image">
                </div>
                <div class="col-lg-6">
                    <div>
                    ...
                    <div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>(+62)<?php echo $_SESSION['notelp']; ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
